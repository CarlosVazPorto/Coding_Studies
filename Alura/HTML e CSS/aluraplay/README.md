...
App para visualização de vídeos da Alura.
<br>
Do curso da Alura "CSS: Flexbox e layouts responsivos".

## 🔨 Funcionalidades do projeto

App em HTML e CSS que permite acessar e assistir a vídeos.
...
Você pode acessar o resultado do projeto no [Vercel](https://alura-play-ten-bay.vercel.app/).