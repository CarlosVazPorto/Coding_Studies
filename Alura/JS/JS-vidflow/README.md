![Banner](./img/readme/vidflow-banner.png)

# VidFlow

App de visualização de vídeos.
<br>
Do curso da Alura "JavaScript: consumindo e tratando os dados de uma API".

## 🔨 Funcionalidades do projeto

App em HTML, CSS e JavaScript, que permite a visualização e a filtragem de vídeos.
